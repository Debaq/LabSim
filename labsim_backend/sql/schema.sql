...
CREATE TABLE IF NOT EXISTS llm_config (
    ...
    -- Vacío = usa LlmConfig::DEFAULT_SALA_PROMPT -- prompt de las consultas
    -- en que el paciente viene acompañado (ver Sala.php): el modelo
    -- interpreta a todos los presentes y decide en cada turno quién
...
CREATE TABLE IF NOT EXISTS llm_chat_logs (
    ...
    -- Quién habló, ahora que el paciente puede venir acompañado (ver
    ...
    -- seguir leyéndose como ocurrió. Vacío en las filas anteriores a esto
    -- y en los turnos del alumno (role='user').
...
CREATE TABLE IF NOT EXISTS chat_comments (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    chat_log_id INTEGER NOT NULL REFERENCES llm_chat_logs(id),
