...
<div class="card">
    ...
    <p class="help">Quiénes vienen con el paciente. Cada persona que agregues acá contesta por sí misma en el chat, con su propia versión de la historia: si su versión contradice la del paciente, el alumno se encuentra con las dos.</p>
