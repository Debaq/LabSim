# Decisiones y registro de cambios

Historia de LabSim: qué se hizo, por qué y qué se descartó. **Las casillas de
este archivo no se mantienen**: lo pendiente vive en `TODO.md`, que enlaza acá
