...
from PySide6.QtWidgets import (QApplication, QDial, QFrame, QGroupBox,
    ...
    QWidget)
from lib.audiometer.WidgetsExtends import ExtendedLabel
...
class Ui_Audiometer(object):
    def setupUi(self, Audiometer):
        ...
        self.lbl_int_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_trans_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_step_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_output_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_stim_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_contin_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_rev_ch0 = ExtendedLabel(self.display)
        ...
        self.lbl_stimOn_ch0 = ExtendedLabel(self.display)
        self.lbl_stimOn_ch0.setObjectName(u"lbl_stimOn_ch0")
        self.lbl_stimOn_ch0.setAutoFillBackground(False)

        self.verticalLayout_4.addWidget(self.lbl_stimOn_ch0)
        ...
        self.vmeter_ch0 = QProgressBar(self.horizontalFrame_2)
        self.vmeter_ch0.setObjectName(u"vmeter_ch0")
        self.vmeter_ch0.setMinimumSize(QSize(7, 0))
        self.vmeter_ch0.setMaximumSize(QSize(7, 16777215))
        self.vmeter_ch0.setFont(font1)
        self.vmeter_ch0.setStyleSheet(u"QProgressBar::chunk {\n"
"                background-color: #55ff7f;\n"
"            }")
        self.vmeter_ch0.setValue(0)
        self.vmeter_ch0.setAlignment(Qt.AlignCenter)
        self.vmeter_ch0.setOrientation(Qt.Vertical)

        self.horizontalLayout_20.addWidget(self.vmeter_ch0)
        ...
        self.lbl_freq = ExtendedLabel(self.central)
        ...
        self.lbl_prueba = ExtendedLabel(self.central)
        ...
        self.lbl_ext_ch0 = ExtendedLabel(self.central)
        self.lbl_ext_ch0.setObjectName(u"lbl_ext_ch0")
        self.lbl_ext_ch0.setMinimumSize(QSize(90, 0))
        self.lbl_ext_ch0.setMaximumSize(QSize(90, 15))
        font4 = QFont()
        font4.setPointSize(9)
        self.lbl_ext_ch0.setFont(font4)

        self.horizontalLayout_21.addWidget(self.lbl_ext_ch0)

        self.lbl_warning_cent = ExtendedLabel(self.central)
        self.lbl_warning_cent.setObjectName(u"lbl_warning_cent")
        self.lbl_warning_cent.setMinimumSize(QSize(90, 0))
        self.lbl_warning_cent.setMaximumSize(QSize(90, 15))
        self.lbl_warning_cent.setFont(font4)

        self.horizontalLayout_21.addWidget(self.lbl_warning_cent)

        self.lbl_ext_ch1 = ExtendedLabel(self.central)
        self.lbl_ext_ch1.setObjectName(u"lbl_ext_ch1")
        self.lbl_ext_ch1.setMinimumSize(QSize(90, 0))
        self.lbl_ext_ch1.setMaximumSize(QSize(90, 15))
        self.lbl_ext_ch1.setFont(font4)
        self.lbl_ext_ch1.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_21.addWidget(self.lbl_ext_ch1)
        ...
        self.vmeter_ch1 = QProgressBar(self.horizontalFrame)
        self.vmeter_ch1.setObjectName(u"vmeter_ch1")
        self.vmeter_ch1.setMinimumSize(QSize(7, 0))
        self.vmeter_ch1.setMaximumSize(QSize(7, 16777215))
        self.vmeter_ch1.setStyleSheet(u"QProgressBar::chunk {\n"
"                background-color: #55ff7f;\n"
"            }")
        self.vmeter_ch1.setValue(0)
        self.vmeter_ch1.setOrientation(Qt.Vertical)

        self.horizontalLayout_19.addWidget(self.vmeter_ch1)
        ...
        self.lbl_int_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_trans_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_step_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_output_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_stim_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_contin_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_rev_ch1 = ExtendedLabel(self.display)
        ...
        self.lbl_stimOn_ch1 = ExtendedLabel(self.display)
        self.lbl_stimOn_ch1.setObjectName(u"lbl_stimOn_ch1")

        self.verticalLayout_2.addWidget(self.lbl_stimOn_ch1)
        ...
        self.label_3 = ExtendedLabel(Audiometer)
        ...
        self.label_4 = ExtendedLabel(Audiometer)
        ...
        self.label_5 = ExtendedLabel(Audiometer)
        ...
        self.label_15 = ExtendedLabel(Audiometer)
        ...
        self.btn_output_der_ch0 = QPushButton(Audiometer)
        self.btn_output_der_ch0.setObjectName(u"btn_output_der_ch0")
        self.btn_output_der_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_output_der_ch0.setFont(font4)
        self.btn_output_der_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_11.addWidget(self.btn_output_der_ch0)

        self.btn_output_izq_ch0 = QPushButton(Audiometer)
        self.btn_output_izq_ch0.setObjectName(u"btn_output_izq_ch0")
        self.btn_output_izq_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_output_izq_ch0.setFont(font4)
        self.btn_output_izq_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_11.addWidget(self.btn_output_izq_ch0)

        self.btn_output_sim_ch0 = QPushButton(Audiometer)
        self.btn_output_sim_ch0.setObjectName(u"btn_output_sim_ch0")
        self.btn_output_sim_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_output_sim_ch0.setFont(font4)
        self.btn_output_sim_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_11.addWidget(self.btn_output_sim_ch0)
        ...
        self.label_11 = ExtendedLabel(Audiometer)
        ...
        self.btn_stim_tone_ch0 = QPushButton(Audiometer)
        self.btn_stim_tone_ch0.setObjectName(u"btn_stim_tone_ch0")
        self.btn_stim_tone_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_stim_tone_ch0.setFont(font4)
        self.btn_stim_tone_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_12.addWidget(self.btn_stim_tone_ch0)

        self.btn_stim_fm_ch0 = QPushButton(Audiometer)
        self.btn_stim_fm_ch0.setObjectName(u"btn_stim_fm_ch0")
        self.btn_stim_fm_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_stim_fm_ch0.setFont(font4)
        self.btn_stim_fm_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_12.addWidget(self.btn_stim_fm_ch0)

        self.btn_stim_speech_ch0 = QPushButton(Audiometer)
        self.btn_stim_speech_ch0.setObjectName(u"btn_stim_speech_ch0")
        self.btn_stim_speech_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_stim_speech_ch0.setFont(font4)
        self.btn_stim_speech_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_12.addWidget(self.btn_stim_speech_ch0)
        ...
        self.btn_stim_wn_ch0 = QPushButton(Audiometer)
        self.btn_stim_wn_ch0.setObjectName(u"btn_stim_wn_ch0")
        sizePolicy2 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.btn_stim_wn_ch0.sizePolicy().hasHeightForWidth())
        self.btn_stim_wn_ch0.setSizePolicy(sizePolicy2)
        self.btn_stim_wn_ch0.setMaximumSize(QSize(35, 25))
        self.btn_stim_wn_ch0.setFont(font1)
        self.btn_stim_wn_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout_15.addWidget(self.btn_stim_wn_ch0)

        self.btn_stim_nbn_ch0 = QPushButton(Audiometer)
        self.btn_stim_nbn_ch0.setObjectName(u"btn_stim_nbn_ch0")
        sizePolicy2.setHeightForWidth(self.btn_stim_nbn_ch0.sizePolicy().hasHeightForWidth())
        self.btn_stim_nbn_ch0.setSizePolicy(sizePolicy2)
        self.btn_stim_nbn_ch0.setMaximumSize(QSize(35, 25))
        self.btn_stim_nbn_ch0.setFont(font1)
        self.btn_stim_nbn_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout_15.addWidget(self.btn_stim_nbn_ch0)
        ...
        self.btn_stim_pn_ch0 = QPushButton(Audiometer)
        self.btn_stim_pn_ch0.setObjectName(u"btn_stim_pn_ch0")
        self.btn_stim_pn_ch0.setMaximumSize(QSize(35, 25))
        self.btn_stim_pn_ch0.setFont(font1)
        self.btn_stim_pn_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout_3.addWidget(self.btn_stim_pn_ch0)

        self.btn_stim_sn_ch0 = QPushButton(Audiometer)
        self.btn_stim_sn_ch0.setObjectName(u"btn_stim_sn_ch0")
        sizePolicy2.setHeightForWidth(self.btn_stim_sn_ch0.sizePolicy().hasHeightForWidth())
        self.btn_stim_sn_ch0.setSizePolicy(sizePolicy2)
        self.btn_stim_sn_ch0.setMaximumSize(QSize(35, 25))
        self.btn_stim_sn_ch0.setFont(font1)
        self.btn_stim_sn_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout_3.addWidget(self.btn_stim_sn_ch0)
        ...
        self.label_10 = ExtendedLabel(Audiometer)
        ...
        self.btn_trans_aer_ch0 = QPushButton(Audiometer)
        self.btn_trans_aer_ch0.setObjectName(u"btn_trans_aer_ch0")
        self.btn_trans_aer_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_trans_aer_ch0.setFont(font4)
        self.btn_trans_aer_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_14.addWidget(self.btn_trans_aer_ch0)

        self.btn_trans_ose_ch0 = QPushButton(Audiometer)
        self.btn_trans_ose_ch0.setObjectName(u"btn_trans_ose_ch0")
        self.btn_trans_ose_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_trans_ose_ch0.setFont(font4)
        self.btn_trans_ose_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_14.addWidget(self.btn_trans_ose_ch0)

        self.btn_trans_cl_ch0 = QPushButton(Audiometer)
        self.btn_trans_cl_ch0.setObjectName(u"btn_trans_cl_ch0")
        self.btn_trans_cl_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_trans_cl_ch0.setFont(font4)
        self.btn_trans_cl_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_14.addWidget(self.btn_trans_cl_ch0)
        ...
        self.btn_step_1.setObjectName(u"btn_step_ch1")
        ...
        self.label_12 = ExtendedLabel(Audiometer)
        ...
        self.btn_trans_aer_ch1 = QPushButton(Audiometer)
        self.btn_trans_aer_ch1.setObjectName(u"btn_trans_aer_ch1")
        self.btn_trans_aer_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_trans_aer_ch1.setFont(font4)
        self.btn_trans_aer_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_17.addWidget(self.btn_trans_aer_ch1)

        self.btn_trans_ose_ch1 = QPushButton(Audiometer)
        self.btn_trans_ose_ch1.setObjectName(u"btn_trans_ose_ch1")
        self.btn_trans_ose_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_trans_ose_ch1.setFont(font4)
        self.btn_trans_ose_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_17.addWidget(self.btn_trans_ose_ch1)

        self.btn_trans_cl_ch1 = QPushButton(Audiometer)
        self.btn_trans_cl_ch1.setObjectName(u"btn_trans_cl_ch1")
        self.btn_trans_cl_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_trans_cl_ch1.setFont(font4)
        self.btn_trans_cl_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_17.addWidget(self.btn_trans_cl_ch1)
        ...
        self.label_13 = ExtendedLabel(Audiometer)
        ...
        self.btn_stim_tone_ch1 = QPushButton(Audiometer)
        self.btn_stim_tone_ch1.setObjectName(u"btn_stim_tone_ch1")
        self.btn_stim_tone_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_stim_tone_ch1.setFont(font4)
        self.btn_stim_tone_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_16.addWidget(self.btn_stim_tone_ch1)

        self.btn_stim_fm_ch1 = QPushButton(Audiometer)
        self.btn_stim_fm_ch1.setObjectName(u"btn_stim_fm_ch1")
        self.btn_stim_fm_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_stim_fm_ch1.setFont(font4)
        self.btn_stim_fm_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_16.addWidget(self.btn_stim_fm_ch1)

        self.btn_stim_speech_ch1 = QPushButton(Audiometer)
        self.btn_stim_speech_ch1.setObjectName(u"btn_stim_speech_ch1")
        self.btn_stim_speech_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_stim_speech_ch1.setFont(font4)
        self.btn_stim_speech_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_16.addWidget(self.btn_stim_speech_ch1)
        ...
        self.btn_stim_wn_ch1 = QPushButton(Audiometer)
        self.btn_stim_wn_ch1.setObjectName(u"btn_stim_wn_ch1")
        sizePolicy2.setHeightForWidth(self.btn_stim_wn_ch1.sizePolicy().hasHeightForWidth())
        self.btn_stim_wn_ch1.setSizePolicy(sizePolicy2)
        self.btn_stim_wn_ch1.setMaximumSize(QSize(35, 25))
        font6 = QFont()
        font6.setPointSize(8)
        font6.setBold(False)
        self.btn_stim_wn_ch1.setFont(font6)
        self.btn_stim_wn_ch1.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_stim_wn_ch1.setAutoExclusive(False)

        self.horizontalLayout_14.addWidget(self.btn_stim_wn_ch1)

        self.btn_stim_nbn_ch1 = QPushButton(Audiometer)
        self.btn_stim_nbn_ch1.setObjectName(u"btn_stim_nbn_ch1")
        self.btn_stim_nbn_ch1.setMaximumSize(QSize(35, 25))
        self.btn_stim_nbn_ch1.setFont(font6)
        self.btn_stim_nbn_ch1.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_stim_nbn_ch1.setCheckable(False)
        self.btn_stim_nbn_ch1.setAutoExclusive(False)

        self.horizontalLayout_14.addWidget(self.btn_stim_nbn_ch1)
        ...
        self.btn_stim_pn_ch1 = QPushButton(Audiometer)
        self.btn_stim_pn_ch1.setObjectName(u"btn_stim_pn_ch1")
        self.btn_stim_pn_ch1.setMaximumSize(QSize(35, 25))
        self.btn_stim_pn_ch1.setFont(font1)
        self.btn_stim_pn_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout_11.addWidget(self.btn_stim_pn_ch1)

        self.btn_stim_sn_ch1 = QPushButton(Audiometer)
        self.btn_stim_sn_ch1.setObjectName(u"btn_stim_sn_ch1")
        sizePolicy2.setHeightForWidth(self.btn_stim_sn_ch1.sizePolicy().hasHeightForWidth())
        self.btn_stim_sn_ch1.setSizePolicy(sizePolicy2)
        self.btn_stim_sn_ch1.setMaximumSize(QSize(35, 25))
        self.btn_stim_sn_ch1.setFont(font6)
        self.btn_stim_sn_ch1.setCursor(QCursor(Qt.PointingHandCursor))
        self.btn_stim_sn_ch1.setAutoExclusive(False)

        self.horizontalLayout_11.addWidget(self.btn_stim_sn_ch1)
        ...
        self.label_14 = ExtendedLabel(Audiometer)
        ...
        self.btn_output_der_ch1 = QPushButton(Audiometer)
        self.btn_output_der_ch1.setObjectName(u"btn_output_der_ch1")
        self.btn_output_der_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_output_der_ch1.setFont(font4)
        self.btn_output_der_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_15.addWidget(self.btn_output_der_ch1)

        self.btn_output_izq_ch1 = QPushButton(Audiometer)
        self.btn_output_izq_ch1.setObjectName(u"btn_output_izq_ch1")
        self.btn_output_izq_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_output_izq_ch1.setFont(font4)
        self.btn_output_izq_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_15.addWidget(self.btn_output_izq_ch1)

        self.btn_output_sim_ch1 = QPushButton(Audiometer)
        self.btn_output_sim_ch1.setObjectName(u"btn_output_sim_ch1")
        self.btn_output_sim_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_output_sim_ch1.setFont(font4)
        self.btn_output_sim_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_15.addWidget(self.btn_output_sim_ch1)
        ...
        self.label = ExtendedLabel(Audiometer)
        ...
        self.dial_ch0 = QDial(Audiometer)
        self.dial_ch0.setObjectName(u"dial_ch0")
        self.dial_ch0.setCursor(QCursor(Qt.OpenHandCursor))
        self.dial_ch0.setLayoutDirection(Qt.LeftToRight)
        self.dial_ch0.setAutoFillBackground(False)
        self.dial_ch0.setStyleSheet(u"")
        self.dial_ch0.setMinimum(1)
        self.dial_ch0.setMaximum(20)
        self.dial_ch0.setSingleStep(1)
        self.dial_ch0.setPageStep(1)
        self.dial_ch0.setValue(10)
        self.dial_ch0.setInvertedAppearance(False)
        self.dial_ch0.setWrapping(True)
        self.dial_ch0.setNotchTarget(3.700000000000000)
        self.dial_ch0.setNotchesVisible(False)

        self.verticalLayout_7.addWidget(self.dial_ch0)
        ...
        self.btn_puls_ch0 = QPushButton(Audiometer)
        self.btn_puls_ch0.setObjectName(u"btn_puls_ch0")
        self.btn_puls_ch0.setFont(font4)

        self.verticalLayout_8.addWidget(self.btn_puls_ch0)
        ...
        self.label_2 = ExtendedLabel(Audiometer)
        ...
        self.btn_puls_ch1 = QPushButton(Audiometer)
        self.btn_puls_ch1.setObjectName(u"btn_puls_ch1")
        self.btn_puls_ch1.setFont(font4)

        self.verticalLayout_10.addWidget(self.btn_puls_ch1)
        ...
        self.dial_izq.setObjectName(u"dial_ch1")
    ...
    def retranslateUi(self, Audiometer):
        ...
        self.lbl_stimOn_ch0.setText("")
        self.vmeter_ch0.setFormat("")
        ...
        self.lbl_warning_cent.setText("")
        self.lbl_ext_ch1.setText("")
        self.vmeter_ch1.setFormat("")
        ...
        self.btn_output_der_ch0.setText(QCoreApplication.translate("Audiometer", u"Derecha", None))
        self.btn_output_izq_ch0.setText(QCoreApplication.translate("Audiometer", u"Izquierda", None))
        self.btn_output_sim_ch0.setText(QCoreApplication.translate("Audiometer", u"Simult\u00e1neo", None))
        self.label_11.setText(QCoreApplication.translate("Audiometer", u"Est\u00edmulo", None))
        self.btn_stim_tone_ch0.setText(QCoreApplication.translate("Audiometer", u"Tono", None))
        self.btn_stim_fm_ch0.setText(QCoreApplication.translate("Audiometer", u"FM", None))
        self.btn_stim_speech_ch0.setText(QCoreApplication.translate("Audiometer", u"Habla", None))
        self.btn_stim_wn_ch0.setText(QCoreApplication.translate("Audiometer", u"WN", None))
        self.btn_stim_nbn_ch0.setText(QCoreApplication.translate("Audiometer", u"NBN", None))
        self.btn_stim_pn_ch0.setText(QCoreApplication.translate("Audiometer", u"PN", None))
        self.btn_stim_sn_ch0.setText(QCoreApplication.translate("Audiometer", u"SN", None))
        self.label_10.setText(QCoreApplication.translate("Audiometer", u"Transductor", None))
        self.btn_trans_aer_ch0.setText(QCoreApplication.translate("Audiometer", u"A\u00e9reo", None))
        self.btn_trans_ose_ch0.setText(QCoreApplication.translate("Audiometer", u"Osea", None))
        self.btn_trans_cl_ch0.setText(QCoreApplication.translate("Audiometer", u"C. libre", None))
        ...
        self.btn_trans_aer_ch1.setText(QCoreApplication.translate("Audiometer", u"A\u00e9reo", None))
        self.btn_trans_ose_ch1.setText(QCoreApplication.translate("Audiometer", u"Osea", None))
        self.btn_trans_cl_ch1.setText(QCoreApplication.translate("Audiometer", u"C. libre", None))
        self.label_13.setText(QCoreApplication.translate("Audiometer", u"Est\u00edmulo", None))
        self.btn_stim_tone_ch1.setText(QCoreApplication.translate("Audiometer", u"Tono", None))
        self.btn_stim_fm_ch1.setText(QCoreApplication.translate("Audiometer", u"FM", None))
        self.btn_stim_speech_ch1.setText(QCoreApplication.translate("Audiometer", u"Habla", None))
        self.btn_stim_wn_ch1.setText(QCoreApplication.translate("Audiometer", u"WN", None))
        self.btn_stim_nbn_ch1.setText(QCoreApplication.translate("Audiometer", u"NBN", None))
        self.btn_stim_pn_ch1.setText(QCoreApplication.translate("Audiometer", u"PN", None))
        self.btn_stim_sn_ch1.setText(QCoreApplication.translate("Audiometer", u"SN", None))
        self.label_14.setText(QCoreApplication.translate("Audiometer", u"Salida", None))
        self.btn_output_der_ch1.setText(QCoreApplication.translate("Audiometer", u"Derecha", None))
        self.btn_output_izq_ch1.setText(QCoreApplication.translate("Audiometer", u"Izquierda", None))
        self.btn_output_sim_ch1.setText(QCoreApplication.translate("Audiometer", u"Simult\u00e1neo", None))
        self.label.setText(QCoreApplication.translate("Audiometer", u"Talkback", None))
        self.btn_puls_ch0.setText(QCoreApplication.translate("Audiometer", u"Pulsado", None))
