...
"color: rgb(255, 255, 255);")
        ...
        self.lbl_probe_freq = QtWidgets.QLabel(self.horizontalFrame)
        self.lbl_probe_freq.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lbl_probe_freq.setObjectName("lbl_probe_freq")
        self.horizontalLayout.addWidget(self.lbl_probe_freq)
