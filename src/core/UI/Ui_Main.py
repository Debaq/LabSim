...
"}")
        ...
        self.lbl_cronometro = QtWidgets.QLabel(self.tool)
        self.lbl_cronometro.setObjectName("lbl_cronometro")
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.lbl_cronometro.setFont(font)
        self.lbl_cronometro.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.layout_bar.addWidget(self.lbl_cronometro)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_cronometro.setText(_translate("MainWindow", ""))
