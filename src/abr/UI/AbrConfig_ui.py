...
class Ui_Abr_Config(object):
    ...
    def retranslateUi(self, Abr_Config):
        ...
        self.cb_stim.setItemText(1, QCoreApplication.translate("Abr_Config", u"CE-Chirp", None))
        self.cb_stim.setItemText(2, QCoreApplication.translate("Abr_Config", u"CE-Chirp LS", None))
        self.cb_stim.setItemText(3, QCoreApplication.translate("Abr_Config", u"NB CE-Chirp LS 500 Hz", None))
        self.cb_stim.setItemText(4, QCoreApplication.translate("Abr_Config", u"NB CE-Chirp LS 1 kHz", None))
        self.cb_stim.setItemText(5, QCoreApplication.translate("Abr_Config", u"NB CE-Chirp LS 2 kHz", None))
        self.cb_stim.setItemText(6, QCoreApplication.translate("Abr_Config", u"NB CE-Chirp LS 4 kHz", None))
        self.cb_stim.setItemText(7, QCoreApplication.translate("Abr_Config", u"Burst 500 Hz", None))
        self.cb_stim.setItemText(8, QCoreApplication.translate("Abr_Config", u"Burst 1 kHz", None))
        self.cb_stim.setItemText(9, QCoreApplication.translate("Abr_Config", u"Burst 2 kHz", None))
        self.cb_stim.setItemText(10, QCoreApplication.translate("Abr_Config", u"Burst 4 kHz", None))
