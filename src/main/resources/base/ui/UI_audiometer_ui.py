...
################################################################################
## Form generated from reading UI file 'UI_audiometer.ui'
##
...
class Ui_Audiometer(object):
    def setupUi(self, Audiometer):
        ...
        self.lbl_warning_stim_ch0 = QLabel(self.display)
        self.lbl_warning_stim_ch0.setObjectName(u"lbl_warning_stim_ch0")
        self.lbl_warning_stim_ch0.setAutoFillBackground(False)

        self.verticalLayout_4.addWidget(self.lbl_warning_stim_ch0)
...
"            }")
        ...
        self.lbl_ext_ch0 = QLabel(self.central)
        ...
        self.lbl_ext_ch1 = QLabel(self.central)
...
"            }")
        ...
        self.lbl_warning_stim_ch1 = QLabel(self.display)
        self.lbl_warning_stim_ch1.setObjectName(u"lbl_warning_stim_ch1")

        self.verticalLayout_2.addWidget(self.lbl_warning_stim_ch1)
        ...
        self.btn_output_r_ch0 = QPushButton(Audiometer)
        self.btn_output_r_ch0.setObjectName(u"btn_output_r_ch0")
        self.btn_output_r_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_output_r_ch0.setFont(font4)
        self.btn_output_r_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_11.addWidget(self.btn_output_r_ch0)

        self.btn_output_l_ch0 = QPushButton(Audiometer)
        self.btn_output_l_ch0.setObjectName(u"btn_output_l_ch0")
        self.btn_output_l_ch0.setMaximumSize(QSize(16777215, 25))
        self.btn_output_l_ch0.setFont(font4)
        self.btn_output_l_ch0.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_11.addWidget(self.btn_output_l_ch0)
        ...
        self.btn_alt_frec.setCheckable(True)
        ...
        self.btn_ext_range.setCheckable(True)
        ...
        self.btn_output_r_ch1 = QPushButton(Audiometer)
        self.btn_output_r_ch1.setObjectName(u"btn_output_r_ch1")
        self.btn_output_r_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_output_r_ch1.setFont(font4)
        self.btn_output_r_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_15.addWidget(self.btn_output_r_ch1)

        self.btn_output_l_ch1 = QPushButton(Audiometer)
        self.btn_output_l_ch1.setObjectName(u"btn_output_l_ch1")
        self.btn_output_l_ch1.setMaximumSize(QSize(16777215, 25))
        self.btn_output_l_ch1.setFont(font4)
        self.btn_output_l_ch1.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_15.addWidget(self.btn_output_l_ch1)
        ...
        self.dial_ch1 = QDial(Audiometer)
        self.dial_ch1.setObjectName(u"dial_ch1")
        self.dial_ch1.setCursor(QCursor(Qt.OpenHandCursor))
        self.dial_ch1.setMinimum(1)
        self.dial_ch1.setMaximum(20)
        self.dial_ch1.setSingleStep(1)
        self.dial_ch1.setPageStep(1)
        self.dial_ch1.setValue(10)
        self.dial_ch1.setWrapping(True)

        self.verticalLayout_9.addWidget(self.dial_ch1)
    ...
    def retranslateUi(self, Audiometer):
        ...
        self.lbl_warning_stim_ch0.setText("")
        ...
        self.lbl_warning_stim_ch1.setText("")
        ...
        self.btn_output_r_ch0.setText(QCoreApplication.translate("Audiometer", u"Derecha", None))
        self.btn_output_l_ch0.setText(QCoreApplication.translate("Audiometer", u"Izquierda", None))
        ...
        self.btn_output_r_ch1.setText(QCoreApplication.translate("Audiometer", u"Derecha", None))
        self.btn_output_l_ch1.setText(QCoreApplication.translate("Audiometer", u"Izquierda", None))
...
#if QT_CONFIG(shortcut)
        self.btn_stim_ch0.setShortcut(QCoreApplication.translate("Audiometer", u"Space", None))
#endif // QT_CONFIG(shortcut)
