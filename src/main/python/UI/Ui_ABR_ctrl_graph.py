...
class Ui_ABR_control_curve(object):
    def setupUi(self, ABR_control_curve):
        ...
        self.btn_scale_minus = QLabel(ABR_control_curve)
        self.btn_scale_minus.setObjectName(u"btn_scale_minus")
        self.btn_scale_minus.setMaximumSize(QSize(25, 16777215))
        font2 = QFont()
        font2.setPointSize(6)
        self.btn_scale_minus.setFont(font2)
        self.btn_scale_minus.setAlignment(Qt.AlignCenter)
        ...
        self.pushButton_2 = QPushButton(ABR_control_curve)
...
"border-width: 0px;")
    ...
    def retranslateUi(self, ABR_control_curve):
        ...
        self.label.setText("")
        self.btn_scale_minus.setText(QCoreApplication.translate("ABR_control_curve", u" \u03bcV", None))
        ...
        self.pushButton_2.setText(QCoreApplication.translate("ABR_control_curve", u"-", None))
