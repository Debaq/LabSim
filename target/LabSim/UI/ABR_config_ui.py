...
class Ui_ABR_config(object):
    def setupUi(self, ABR_config):
        ...
        self.cb_filter_down = QComboBox(self.groupBox)
        ...
        self.cb_filter_up = QComboBox(self.groupBox)
    ...
    def retranslateUi(self, ABR_config):
        ...
        self.cb_filter_down.setCurrentText(QCoreApplication.translate("ABR_config", u"1000", None))
        self.label_4.setText(QCoreApplication.translate("ABR_config", u"Pasa Alto :", None))
        self.cb_filter_up.setItemText(0, QCoreApplication.translate("ABR_config", u"50", None))
        self.cb_filter_up.setItemText(1, QCoreApplication.translate("ABR_config", u"100", None))
        self.cb_filter_up.setItemText(2, QCoreApplication.translate("ABR_config", u"200", None))
        self.cb_filter_up.setItemText(3, QCoreApplication.translate("ABR_config", u"300", None))
        self.cb_filter_up.setItemText(4, QCoreApplication.translate("ABR_config", u"400", None))
        self.cb_filter_up.setItemText(5, QCoreApplication.translate("ABR_config", u"500", None))
